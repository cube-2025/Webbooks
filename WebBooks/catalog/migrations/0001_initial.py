    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publisher', models.ForeignKey(help_text='Выберите издательство книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.publisher', verbose_name='Издательство книги')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('status', models.ForeignKey(blank=True, help_text='Изменить состояние книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Статус экзепляра книги')),
            ],
            options={
                'ordering': ['due_back'],
            },
